...
| Change similar-code analysis | [Similar-code analysis](../similar-code-analysis.md), [repository map](repo-map.md), [detection internals](../reference/detection-internals.md), [MCP internals](../reference/mcp-internals.md) or Node/package references when affected, [review routing](review-routing.md) | Bare analysis, CI gates, LSP, and editor surfaces unless the versioned scope changes |
